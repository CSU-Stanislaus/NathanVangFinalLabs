...
public class ArraysLab7 {
    ...
    public static void main(String[] args) {
        ...
        int[] z1 = {2, 5, 8, 11, 14};
        int[] z2 = {1, 3, 5};
        System.out.println("countEvens(z1) = " + countEvens(z1)); // 3
        System.out.println("countEvens(z2) = " + countEvens(z2)); // 0

        // Q5: toStringArray
        int[] demo = {7, 8, 9};
        System.out.println("toStringArray(demo) = " + toStringArray(demo)); // [7, 8, 9]
    }
